...
@SourceType(value = "QuickBaseARP", label = "QuickBase",uiConfig = "quickbase-layout.json")
public class QuickBaseConf extends AbstractArpConf<QuickBaseConf> {
  private static final String ARP_FILENAME = "arp/implementation/quickbase-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.quickbase.QuickBaseDriver";
